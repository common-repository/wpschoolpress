...
function wpsp_UndoImport()
{
	...
	{
        echo sprintf( esc_html( 'Imported  %s rows are removed successfully!!', 'wpschoolpress' ), $count );
...
function wpsp_StudentCount()
{
	...
	{
        echo sprintf( esc_html( 'There are %s students associated with this class.', 'wpschoolpress' ), $count );
